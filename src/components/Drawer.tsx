  ...
  return (
    ...
    >
      ...
      >
        ...
        <StyledList
          subheader={
            <ListSubheader component="div">{t("Pages")}</ListSubheader>
          }
        >
          <DrawerListItem
          ...
          <DrawerListItem
            ...
            CustomIcon={FormatListBulletedIcon}
            text={t("Recipes")}
          />
          <DrawerListItem
            to={RouteTagsName}
        ...
        <Divider />
        <StyledList
          subheader={<ListSubheader component="div">{t("Mode")}</ListSubheader>}
        >
          <ListItem
            disablePadding
        ...
        <Divider />
        <StyledList
          subheader={<ListSubheader component="div">{t("News")}</ListSubheader>}
        >
          <DrawerListItem
            to={RouteChangelogsName}
            CustomIcon={ChecklistIcon}
            text={t("ChangeLogs")}
          />
        </StyledList>
      </Box>
