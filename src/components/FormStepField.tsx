...
export function FormStepField<T extends FieldValues>(
  props: FormStepFieldProps<T>,
) {
  ...
  return (
    <Draggable draggableId={`steps-item-${index}`} index={index}>
      {(provided) => (
          ...
          <Box sx={{ display: "flex", flexDirection: "row" }} gap={1}>
            ...
            <Controller
              ...
              render={({
                ...
                <TextField
                  label={watch(isSectionName) ? t("Section") : t("Step")}
