...
import {
  getUserPreferedColorMode,
  saveUserPreferedColorMode,
...
export function ColorModeProvider({
  ...
  const [colorMode, _setColorMode] = useState<PaletteMode>(
  ...
  return (
    <ColorModeContext.Provider
      value={{ toggleColorMode, colorMode, theme, getTheme }}
    >
      {children}
    </ColorModeContext.Provider>
  );
